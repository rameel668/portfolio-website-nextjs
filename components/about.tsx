  ...
  return (
    ...
    >
        ...
        <p className="mb-3">
            ...
            <span className="font-medium"> Software Engineering</span>, I decided to further develop my skills for programming. I enrolled in a coding bootcamp and learned
            ...
            <span className="font-medium"> React, Next.js, Node.js, and MongoDB</span>. I am also familiar with TypeScript and Prisma. I am always looking to learn new technologies. I am currently looking for a
        ...
        <p>
            ...
            <span className="font-medium"> Health & Wellbeing</span>. I&apos;m also learning how to speak fluent 
